...
.title[
# Sesión 14. Métodos no paramétricos
]
...
1. Estudiaremos métodos para la estimación de densidades

1. Extenderemos la idea de estimación no paramétrica para la estimación de regresiones

1. Introduciremos el concepto de regresión semiparamétrica
...
data.salarios<-read_csv("./datos/salarios.csv",
...
# Muchas gracias por su atención a este curso
