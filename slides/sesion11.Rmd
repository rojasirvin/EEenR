...
.title[
# Sesión 11. Variables instrumentales
]
...
Se puede mostrar que $\hat{\beta}_1$ es consistente (usaríamos teoría asintótica para probarlo)
...
1. La base de datos *ingresos_iv.dta* contiene una muestra de hombres de entre 24 y 36 años de edad.

1. Estime una regresión por MCO para explicar el logaritmo del salario (**lwage**) en función de la educación **educ** y los siguientes controles: **exper**, **expersq**, **black**, **south**, **smsa**, **reg661**, **reg662**, **reg663**, **reg664**, **reg665**, **reg666**, **reg667**, **reg668** y **smsa66**. ¿El coeficiente sobre **educ** tiene una interpretación causal del efecto de la educación en el salario?

1. Estime la relación entre el logaritmo del salario y la educación usando la variable dicotómica de acceso a una universidad (**nearc4**) como instrumento. Emplee las mismas variables de control que en el modelo de MCO.

1. Realice ahora el siguiente procedimiento. Primero, estime la primera etapa usando una regresión por MCO. Obtenga los valores ajustados de educación y llámelos **educ_hat**. Luego, estime la segunda etapa empleando **educ_hat** como variable independiente, además del resto de variables de control. ¿Cómo cambian sus resultados en comparación con la parte d.?


---
# Próxima sesión

Hablaremos sobre modelos cuya variable dependiente no es continua

Estudiaremos la teoría detrás de estos modelos
