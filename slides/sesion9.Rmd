...
Recordemos que la distribución normal está dada por la siguiente función de distribución:

$$f(x)=\cases{ \frac{1}{b-a} \quad \text{si}\quad 0 \leq x \leq b  \\ 0 \quad \text{en otro caso} }$$
